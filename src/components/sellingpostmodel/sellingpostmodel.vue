    ...
    <transition name="modal-fade">
        <div class="post-modal" v-if="visible">
            <div class="modal-content">
                <h2>发布购物帖</h2>
                <!-- 输入文字的文本框 -->
                <textarea v-model="posttitle" placeholder="请输入购物帖标题"></textarea>
                <!-- 输入文字的文本框 -->
                <textarea v-model="postContent" placeholder="请输入购物帖内容"></textarea>
                <!-- 上传图片部分，这里只是示例，实际可能需要使用文件上传组件等 -->
                <button @click="showModal = true">添加商品信息</button>
               ...
               <div v-if="showModal" class="modal">
                <div class="modal-content">
                   ...
                   <input type="text" id="productName" v-model="productTitle" required>
                   <p>
...
export default {
    ...
    methods: {
        ...
        confirmPost() {
            ...
            axios.post('http://127.0.0.1:8000/create_selling_post/', {
                content:content,
                titles:titles,
                price:price,
